...
FluScrollablePage{
    ...
    ListModel{
        id:model_header
        ListElement{
            icon:"qrc:/assert/icon.png"
            title:"OwlLive GitHub"
            desc:"支持课堂直播、讨论区、AI辅助教学的多功能的在线教学系统."
            url:"https://github.com/OctalZero/OwlLive"
        }
    }
    ...
    Item{
        ...
        Image {
            ...
            source: "qrc:/res/image/bg_home_header.jpg"
        }
        // 遮罩效果
        Rectangle{
            anchors.fill: parent
            gradient: Gradient{
                ...
                GradientStop { position: 0; color: FluTheme.dark ? Qt.rgba(0,0,0,1) : Qt.rgba(1,1,1,1) }
                GradientStop { position: 0.2; color: FluTheme.dark ? Qt.rgba(0,0,0,0) : Qt.rgba(1,1,1,0) }
            }
        }
